...
| IPsecSet.n | No | Array | IPSec configuration. The IPSec secure session configuration is provided by Tencent Cloud. See [VPN Connection-IPSec Configuration](https://intl.cloud.tencent.com/document/product/1037/39635) for details. |
